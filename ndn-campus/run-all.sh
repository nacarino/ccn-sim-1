...
function usage() {
    echo "Script to automize running a continuous set of ns3 scenarios"
    echo "Options:"
    echo "    -c NUM    Max number of clients (consumers) for the scenario. Default [$CFLAG]."
    echo "              Starts at 1"
    echo "    -n NUM    Max number of networks the scenario will have. Default [$NFLAG]."
    echo "              Starts at 1"
    echo "    -p NUM    Max number of servers (producers) for the scenario. Default [$PFLAG]."
    echo "              Starts at 1"
